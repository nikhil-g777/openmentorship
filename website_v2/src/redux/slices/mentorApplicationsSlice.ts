...
export const {updateMentorApplications, updateMentor} =
  mentorApplicationsSlice.actions;

// Other code such as selectors can use the imported `RootState` type
export const selectMentorApplications = (state: RootState) =>
  state.mentorApplications.mentorApplications;
export const selectMentor = (state: RootState) =>
  state.mentorApplications.mentor;
