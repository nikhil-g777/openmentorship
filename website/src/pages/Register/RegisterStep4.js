...
import { FormGroup, FormControl, FormControlLabel, Checkbox, Radio, RadioGroup, SnackbarContent } from "@material-ui/core"
  ...
  return (
    <Container>
      ...
      <SectionWrapper>
        ...
        <SnackbarContent message="Pro tip : Being focussed with your goals helps you get better matches." style={{background: "#69b595", margin:"15px 0"}}/>
        <FormGroup column>
          <FormControlLabel
      ...
      <SectionWrapper>
        ...
        <FormControl component="fieldset">
          <RadioGroup name="frequency" value={communicationFrequency} onChange={handleFrequency}>
            <FormControlLabel value="weekly" control={<Radio classes={{root: classes.radio, checked: classes.checked}} />} label="Weekly" />
            <FormControlLabel value="biweekly" control={<Radio classes={{root: classes.radio, checked: classes.checked}} />} label="Bi-weekly" />
            <FormControlLabel value="onceamonth" control={<Radio classes={{root: classes.radio, checked: classes.checked}}/>} label="Once a month" />
            <FormControlLabel value="nopreference" control={<Radio classes={{root: classes.radio, checked: classes.checked}}/>} label="No preference" />
          </RadioGroup>
        </FormControl>
      </SectionWrapper>
      <SectionWrapper>
      ...
      {props.values.emptyField && <p style={{textAlign: "center"}}>Please choose at least one option</p>}
      <DotStepper
        activeStep={3}
